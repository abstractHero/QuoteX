...
class SearchableDataSourceFactory @Inject constructor(private val databaseQuoteRepository: DatabaseQuoteRepository) :
    DataSource.Factory<Int, Quote>() {

    var searchQuery: String = ""

    override fun create(): DataSource<Int, Quote> = databaseQuoteRepository.getAllQuotes(searchQuery).create()
